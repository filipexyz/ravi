...
- A turn recovered after an ambiguous provider delivery outcome MUST keep one stable client delivery id. The provider adapter MUST reconcile that id against compatible resumed provider state before deciding whether to reattach, hydrate a completed turn, or replay.

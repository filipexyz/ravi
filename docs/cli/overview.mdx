...
ravi instances delete <name> --execute        # Soft-delete instance (without --execute: dry-run, exit 3)
...
ravi instances routes remove <name> <pattern> --execute  # Soft-delete route (without --execute: dry-run, exit 3)
...
ravi contacts block <contact> --execute       # Block a contact (without --execute it is a dry-run, exit 3)

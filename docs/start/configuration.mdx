...
### Runtime Resilience (optional)

| Variable | Default | Description |
| --- | --- | --- |
| `RAVI_RUNTIME_EVENT_LOOP_MAX_RESTARTS` | `2` | Maximum automatic restarts after a provider event loop closes. Set to `0` to disable automatic replay |

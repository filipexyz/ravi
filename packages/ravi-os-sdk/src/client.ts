...
export class RaviClient {
  ...
  readonly agents = {
    ...
    /** Set or show the ordered Hub intelligence connections for an agent */
    intelligence: async (id: string, options?: {
      clear?: boolean;
      connections?: string;
      execute?: boolean;
      profile?: string;
      required?: string;
    }): Promise<AgentsIntelligenceReturn> => {
      return this.transport.call({
        groupSegments: ["agents"],

...
export class RaviClient {
  ...
  readonly chats = {
    ...
    lists: {
      ...
      /** Explain why a contact or chat matches (or doesn't) a dynamic list */
      explain: async (list: string, options?: {
        owner?: string;
        target?: string;
      }): Promise<ChatsListsExplainReturn> => {
        return this.transport.call({
          groupSegments: ["chats","lists"],
          command: "explain",
          body: { list, ...(options ?? {}) },
      ...
      /** Update a field on a reading list (selector|mode|metadata) */
      set: async (list: string, field: string, value: string, options?: {
        owner?: string;
      }): Promise<ChatsListsSetReturn> => {
        return this.transport.call({
          groupSegments: ["chats","lists"],
          command: "set",
          body: { list, field, value, ...(options ?? {}) },
        });
      },
      /** Run the dynamic membership evaluation cycle */
      tick: async (options?: {
        apply?: boolean;
        limit?: string;
        list?: string;
      }): Promise<ChatsListsTickReturn> => {
        return this.transport.call({
          groupSegments: ["chats","lists"],
          command: "tick",
          body: { ...(options ?? {}) },

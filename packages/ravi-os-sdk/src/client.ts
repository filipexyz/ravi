...
export class RaviClient {
  ...
  readonly cnpj = {
    /** Preview or apply an explicit CNPJ selection as idempotent CRM lead accounts */
    exportCrm: async (options?: {
      apply?: boolean;
      baseUrl?: string;
      capitalMax?: string;
      capitalMin?: string;
    ...
    /** Return the complete registered record for one valid CNPJ */
    get: async (cnpj: string, options?: {
      baseUrl?: string;
      timeoutMs?: string;
    }): Promise<CnpjGetReturn> => {
      return this.transport.call({
        groupSegments: ["cnpj"],
        command: "get",
        body: { cnpj, ...(options ?? {}) },
    ...
    /** Probe the private CNPJ Server with one bounded read-only search */
    health: async (options?: {
      baseUrl?: string;
      timeoutMs?: string;
    }): Promise<CnpjHealthReturn> => {
      return this.transport.call({
        groupSegments: ["cnpj"],
        command: "health",
        body: { ...(options ?? {}) },
    ...
    /** Search active companies with bounded business and opening-date filters */
  ...
  readonly crm = {
    ...
    /** List CRM account cards, including accounts with no contacts or opportunities */

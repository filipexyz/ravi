...
export class RaviClient {
  ...
  readonly crm = {
    ...
    facade: {
      /** Apply one externally approved CRM facade plan */
      apply: async (planId: string): Promise<CrmFacadeApplyReturn> => {
        return this.transport.call({
      ...
      plan: async (operation: string, target: string, options?: {
        ...
        until?: string;
        value?: string;
      }): Promise<CrmFacadePlanReturn> => {
        return this.transport.call({
          groupSegments: ["crm","facade"],
          command: "plan",
          body: { operation, target, ...(options ?? {}) },
        });
      },
      /** Inspect a CRM facade plan without replaying it */
      recover: async (planId: string): Promise<CrmFacadeRecoverReturn> => {
        return this.transport.call({
          groupSegments: ["crm","facade"],
          command: "recover",
          body: { planId },
      ...
      /** Read the current state of a CRM facade plan */
      verify: async (planId: string): Promise<CrmFacadeVerifyReturn> => {
        return this.transport.call({
          groupSegments: ["crm","facade"],
          command: "verify",
          body: { planId },
    ...
    /** Show a machine-readable CRM command overview */
    help: async (): Promise<CrmHelpReturn> => {
      return this.transport.call({
        groupSegments: ["crm"],
        command: "help",
        body: {},
    ...
    lifecycle: {
      /** Show CRM lifecycle states and transitions */
      show: async (): Promise<CrmLifecycleShowReturn> => {
        return this.transport.call({
          groupSegments: ["crm","lifecycle"],
          command: "show",
          body: {},
        });
      }
    ...
    pipeline: {
      ...
      /** Review pipeline metadata; exits 1 when high-severity gaps are found */

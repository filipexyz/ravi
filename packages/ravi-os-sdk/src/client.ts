...
export class RaviClient {
  ...
  readonly bug = {
    ...
    comment: async (id: string, options?: {
      console?: string;
      dossierFile?: string;
      dossierJson?: string;
      evidenceFile?: string;
  ...
  readonly jobs = {
    /** Stop a running job */
    kill: async (id: string): Promise<JobsKillReturn> => {
      return this.transport.call({
        groupSegments: ["jobs"],
        command: "kill",
        body: { id },
    ...
    /** Start a long command in the background and return immediately */
    run: async (command: string[], options?: {
      agent?: string;
      cwd?: string;
      session?: string;
      wait?: boolean;
    }): Promise<JobsRunReturn> => {
      return this.transport.call({
        groupSegments: ["jobs"],
        command: "run",
        body: { command, ...(options ?? {}) },
    ...
    /** Show one job */
    show: async (id: string): Promise<JobsShowReturn> => {
      return this.transport.call({
        groupSegments: ["jobs"],
        command: "show",
        body: { id },
    ...
    /** Print the job log tail */
    tail: async (id: string, options?: {
      lines?: string;
    }): Promise<JobsTailReturn> => {
      return this.transport.call({
        groupSegments: ["jobs"],
        command: "tail",
        body: { id, ...(options ?? {}) },
    ...
    wait: async (id: string, options?: {
      timeout?: string;
    }): Promise<JobsWaitReturn> => {
      return this.transport.call({
        groupSegments: ["jobs"],
        command: "wait",
        body: { id, ...(options ?? {}) },

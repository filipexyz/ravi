...
export class RaviClient {
  ...
  readonly specs = {
    facade: {
      /** Apply one bound specs plan and confirm it by readback */
      apply: async (operation: string, planHash: string, id?: string, options?: {
        full?: boolean;
        kind?: string;
        title?: string;
      }): Promise<SpecsFacadeApplyReturn> => {
        return this.transport.call({
          groupSegments: ["specs","facade"],
          command: "apply",
          body: { operation, planHash, id, ...(options ?? {}) },
        });
      },
      /** Build a bound specs plan without writing state */
      plan: async (operation: string, id?: string, options?: {
        full?: boolean;
        kind?: string;
        title?: string;
      }): Promise<SpecsFacadePlanReturn> => {
        return this.transport.call({
          groupSegments: ["specs","facade"],
          command: "plan",
          body: { operation, id, ...(options ?? {}) },
        });
      },
      /** Read files, ancestors, and index for a bound specs plan */
      readback: async (operation: string, planHash: string, id?: string, options?: {
        full?: boolean;
        kind?: string;
        title?: string;
      }): Promise<SpecsFacadeReadbackReturn> => {
        return this.transport.call({
          groupSegments: ["specs","facade"],
          command: "readback",
          body: { operation, planHash, id, ...(options ?? {}) },
      ...
      /** Inspect recovery without replaying a specs effect */
      recover: async (operation: string, planHash: string, id?: string, options?: {
        full?: boolean;
        kind?: string;
        title?: string;
      }): Promise<SpecsFacadeRecoverReturn> => {
        return this.transport.call({
          groupSegments: ["specs","facade"],
          command: "recover",
          body: { operation, planHash, id, ...(options ?? {}) },
      ...
      /** Classify current state against a bound specs plan */
      verify: async (operation: string, planHash: string, id?: string, options?: {
        full?: boolean;
        kind?: string;
        title?: string;
      }): Promise<SpecsFacadeVerifyReturn> => {
        return this.transport.call({
          groupSegments: ["specs","facade"],
          command: "verify",
          body: { operation, planHash, id, ...(options ?? {}) },

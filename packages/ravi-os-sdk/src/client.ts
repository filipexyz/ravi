...
export class RaviClient {
  ...
  readonly pi = {
    auth: {
      /** Check whether a pi provider is authenticated (never prints the secret) */
      check: async (options?: {
        provider?: string;
      }): Promise<PiAuthCheckReturn> => {
        return this.transport.call({
          groupSegments: ["pi","auth"],
          command: "check",
          body: { ...(options ?? {}) },
        });
      }
    },
    /** Validate the pi setup end-to-end (auth present + model resolves), optionally for one agent */
    doctor: async (options?: {
      agent?: string;
    }): Promise<PiDoctorReturn> => {
      return this.transport.call({
        groupSegments: ["pi"],
        command: "doctor",
        body: { ...(options ?? {}) },
    ...
    models: {
      /** Register a custom/missing pi model via a generated extension (OpenAI-compatible endpoint) */
      add: async (options?: {
        api?: string;
        apiKeyEnv?: string;
        baseUrl?: string;
        ...
        providerId?: string;
        reasoning?: boolean;
      }): Promise<PiModelsAddReturn> => {
        return this.transport.call({
          groupSegments: ["pi","models"],
          command: "add",
          body: { ...(options ?? {}) },
        });
      },
      /** List models pi can resolve (authenticated providers only) */
      list: async (options?: {
        limit?: string;
        offset?: string;
        provider?: string;
        query?: string;
      }): Promise<PiModelsListReturn> => {
        return this.transport.call({
          groupSegments: ["pi","models"],
          command: "list",
          body: { ...(options ?? {}) },
      ...
      /** Remove a custom pi provider/model extension created by this CLI */
      remove: async (options?: {
        providerId?: string;
      }): Promise<PiModelsRemoveReturn> => {
        return this.transport.call({
          groupSegments: ["pi","models"],
          command: "remove",
          body: { ...(options ?? {}) },
    ...
    providers: {
      /** List pi providers and whether they are authenticated in this environment */
      list: async (options?: {
        limit?: string;
        offset?: string;
      }): Promise<PiProvidersListReturn> => {
        return this.transport.call({
          groupSegments: ["pi","providers"],
          command: "list",
          body: { ...(options ?? {}) },
        });
      }
    },
    /** Show pi provider status: version, defaults, authenticated providers, agents using pi */
    status: async (): Promise<PiStatusReturn> => {
      return this.transport.call({
        groupSegments: ["pi"],
        command: "status",
        body: {},

...
export class RaviClient {
  ...
  readonly specs = {
    facade: {
      new: {
        /** Apply one bound spec creation and confirm it */
        apply: async (planHash: string, id: string, title: string, kind: string, options?: {
          full?: boolean;
        }): Promise<SpecsFacadeNewApplyReturn> => {
          return this.transport.call({
            groupSegments: ["specs","facade","new"],
            command: "apply",
            body: { planHash, id, title, kind, ...(options ?? {}) },
          });
        },
        /** Plan one bound spec creation without writing */
        plan: async (id: string, title: string, kind: string, options?: {
          full?: boolean;
        }): Promise<SpecsFacadeNewPlanReturn> => {
          return this.transport.call({
            groupSegments: ["specs","facade","new"],
            command: "plan",
            body: { id, title, kind, ...(options ?? {}) },
          });
        },
        /** Read one bound spec creation target */
        readback: async (planHash: string, id: string, title: string, kind: string, options?: {
          full?: boolean;
        }): Promise<SpecsFacadeNewReadbackReturn> => {
          return this.transport.call({
            groupSegments: ["specs","facade","new"],
            command: "readback",
            body: { planHash, id, title, kind, ...(options ?? {}) },
        ...
        /** Inspect recovery for one bound spec creation */
        recover: async (planHash: string, id: string, title: string, kind: string, options?: {
          full?: boolean;
        }): Promise<SpecsFacadeNewRecoverReturn> => {
          return this.transport.call({
            groupSegments: ["specs","facade","new"],
            command: "recover",
            body: { planHash, id, title, kind, ...(options ?? {}) },
        ...
        /** Classify one bound spec creation target */
        verify: async (planHash: string, id: string, title: string, kind: string, options?: {
          full?: boolean;
        }): Promise<SpecsFacadeNewVerifyReturn> => {
          return this.transport.call({
            groupSegments: ["specs","facade","new"],
            command: "verify",
            body: { planHash, id, title, kind, ...(options ?? {}) },
      ...
      sync: {
        /** Apply one bound specs-index synchronization and confirm it */
        apply: async (planHash: string): Promise<SpecsFacadeSyncApplyReturn> => {
          return this.transport.call({
            groupSegments: ["specs","facade","sync"],
            command: "apply",
            body: { planHash },
          });
        },
        /** Plan one bound specs-index synchronization without writing */
        plan: async (): Promise<SpecsFacadeSyncPlanReturn> => {
          return this.transport.call({
            groupSegments: ["specs","facade","sync"],
            command: "plan",
            body: {},
        ...
        /** Read one bound specs-index target */
        readback: async (planHash: string): Promise<SpecsFacadeSyncReadbackReturn> => {
          return this.transport.call({
            groupSegments: ["specs","facade","sync"],
            command: "readback",
            body: { planHash },
        ...
        /** Inspect recovery for one bound specs-index target */
        recover: async (planHash: string): Promise<SpecsFacadeSyncRecoverReturn> => {
          return this.transport.call({
            groupSegments: ["specs","facade","sync"],
            command: "recover",
            body: { planHash },
        ...
        /** Classify one bound specs-index target */
        verify: async (planHash: string): Promise<SpecsFacadeSyncVerifyReturn> => {
          return this.transport.call({
            groupSegments: ["specs","facade","sync"],
            command: "verify",
            body: { planHash },

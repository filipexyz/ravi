...
export class RaviClient {
  ...
  readonly apps = {
    ...
    /** TEMP: migrate a working production CLI into a Ravi app draft */
    migrateFromCli: async (command: string, options?: {
      description?: string;
      dryRun?: boolean;
      force?: boolean;
      id?: string;
      ...
      skipUi?: boolean;
      source?: string;
    }): Promise<AppsMigrateFromCliReturn> => {
      return this.transport.call({
        groupSegments: ["apps"],
        command: "migrate-from-cli",
        body: { command, ...(options ?? {}) },
      });
    },
    /** TEMP: compare a migrated Ravi app against the working production CLI contract */
    migrationCheck: async (id: string, options?: {
      source?: string;
      sourceCommand?: string;
    }): Promise<AppsMigrationCheckReturn> => {
      return this.transport.call({
        groupSegments: ["apps"],
  ...
  readonly frete = {
    /** Quote one SKU for a destination through the official Olist freight API (read-only) */
    quote: async (integrationId: string, destinationCep: string, sku: string, options?: {
      ...
      return this.transport.call({
        groupSegments: ["frete"],
        command: "quote",
        body: { integrationId, destinationCep, sku, ...(options ?? {}) },
      });
    }
  };
  ...
  readonly memory = {
    ...
    curate: async (options?: {
      agent?: string;
      dryRun?: boolean;
      transcript?: string;
    }): Promise<MemoryCurateReturn> => {
      return this.transport.call({
  ...
  readonly runtime = {
    ...
    targets: {
      /** Disable an agent runtime target policy while preserving unrelated defaults */
      clear: async (options: {
        agent: string;
      }): Promise<RuntimeTargetsClearReturn> => {
        return this.transport.call({
          groupSegments: ["runtime","targets"],
          command: "clear",
          body: { ...(options ?? {}) },
        });
      },
      /** Explain which runtime target an agent would select without executing it */
      explain: async (options: {
        agent: string;
        sessionPolicyJson?: string;
        taskProfile?: string;
      }): Promise<RuntimeTargetsExplainReturn> => {
        return this.transport.call({
          groupSegments: ["runtime","targets"],
          command: "explain",
          body: { ...(options ?? {}) },
      ...
      /** Atomically reorder an existing runtime target policy by stable target ids */
      reorder: async (options: {
        agent: string;
        order: string;
      }): Promise<RuntimeTargetsReorderReturn> => {
        return this.transport.call({
          groupSegments: ["runtime","targets"],
          command: "reorder",
          body: { ...(options ?? {}) },
      ...
      /** Validate and set an agent runtime target policy while preserving unrelated defaults */
      set: async (options: {
        agent: string;
        policyJson: string;
      }): Promise<RuntimeTargetsSetReturn> => {
        return this.transport.call({
          groupSegments: ["runtime","targets"],
          command: "set",
          body: { ...(options ?? {}) },
      ...
      /** Show the complete configured runtime target policy and order for one agent */
      show: async (options: {
        agent: string;
      }): Promise<RuntimeTargetsShowReturn> => {
        return this.transport.call({
          groupSegments: ["runtime","targets"],
          command: "show",
          body: { ...(options ?? {}) },
  ...
  readonly skills = {
    ...
    archive: async (name: string, options?: {
      force?: boolean;
      skill?: string;
    }): Promise<SkillsArchiveReturn> => {
      return this.transport.call({
  ...
  readonly specs = {
    ...
    /** Lint a spec: invariant↔check traceability + Adaptation contract */
    verify: async (id: string): Promise<SpecsVerifyReturn> => {
      return this.transport.call({
        groupSegments: ["specs"],
        command: "verify",
        body: { id },

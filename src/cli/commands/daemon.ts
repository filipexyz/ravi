    ...
    const watchDir = (dir: string) => {
      try {
        watch(dir, { recursive: true }, (eventType, filename) => {
          ...
          // Ignore only the auto-generated index file to prevent build loops
          // This file is regenerated by gen:commands on every build
          const normalizedPath = filename.replace(/\\/g, "/");
          if (normalizedPath === "cli/commands/index.ts" || normalizedPath.endsWith("/cli/commands/index.ts")) {
            return;
          }

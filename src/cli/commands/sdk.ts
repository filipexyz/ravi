...
export class SdkOpenApiCommands {
  ...
  @CommandAccess({ kind: "read", resource: "sdk.openapi", action: "emit", risk: "low", localProject: true })
  ...
  @CommandAccess({ kind: "read", resource: "sdk.openapi", action: "check", risk: "low", localProject: true })
...
export class SdkClientCommands {
  ...
  @CommandAccess({ kind: "mutate", resource: "sdk.client", action: "generate", risk: "high", localProject: true })
  ...
  @CommandAccess({ kind: "read", resource: "sdk.client", action: "check", risk: "low", localProject: true })
...
export class SdkSwiftCommands {
  ...
  @CommandAccess({ kind: "mutate", resource: "sdk.swift", action: "generate", risk: "high", localProject: true })
  @Returns(sdkGenerateReturnSchema)
  generate(
    @Option({
      flags: "--out <path>",
  ...
  @CommandAccess({ kind: "read", resource: "sdk.swift", action: "check", risk: "low", localProject: true })
  @Returns(sdkCheckReturnSchema)
  check(
    @Option({
      flags: "--out <path>",
